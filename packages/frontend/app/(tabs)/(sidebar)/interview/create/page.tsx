...
import DocumentCreateModal from "@/app/(tabs)/(sidebar)/documents/components/document-create-modal";
import DocumentDetailModal from "@/app/(tabs)/(sidebar)/documents/components/document-detail-modal";
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-6 py-12">
      ...
      <section className="flex h-full flex-col gap-4">
        ...
        <div className="flex w-lg gap-3 rounded-lg border px-4 py-6 shadow-sm">
          <IconBox>
