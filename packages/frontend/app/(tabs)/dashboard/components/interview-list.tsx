    ...
    <>
      <div className="flex justify-between">
        <div className="flex items-center gap-2">
          <Clock className="size-5.5 text-muted-foreground" />
          <p className="text-xl font-semibold">최근 인터뷰 기록</p>
        </div>
        <div>
          <p className="cursor-pointer font-semibold text-muted-foreground">
            더보기
          </p>
        </div>
      </div>
